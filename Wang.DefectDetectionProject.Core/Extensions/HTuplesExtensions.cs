...
{
    /// <summary>
    /// HTuple[]扩展方法类，将判断和生成图形对象封装，简化主流程中生成矩形、椭圆、圆形的代码
    /// </summary>
    public static class HTuplesExtensions
    {
        public static HObject? GenRectangle(this HTuple[] hTuples)
        {
            if (hTuples[0] == null || hTuples[1] == null || hTuples[2] == null || hTuples[3] == null) return null;
            if (hTuples[0]!.D == 0 && hTuples[1]!.D == 0 && hTuples[2]!.D == 0 && hTuples[3]!.D == 0) return null;
        ...
        {
            if (hTuples[0] == null || hTuples[1] == null || hTuples[2] == null || hTuples[3] == null || hTuples[4] == null) return null;
            if (hTuples[0]!.D == 0 && hTuples[1]!.D == 0 && hTuples[2]!.D == 0 && hTuples[3]!.D == 0 && hTuples[4]!.D == 0) return null;
        ...
        {
            if (hTuples[0] == null || hTuples[1] == null || hTuples[2] == null) return null;
            if (hTuples[0]!.D == 0 && hTuples[1]!.D == 0 && hTuples[2]!.D == 0) return null;
        ...
        public static void SetString(this HTuple hv_WindowHandle, HTuple hv_String, HTuple hv_CoordSystem, HTuple hv_Row, HTuple hv_Column, HTuple hv_Color, HTuple hv_Box)
        {
